...
namespace RoslynMcpServer.Core.Services
{
    ...
    public class BatchQueryService
    {
        ...
        private string FormatSearchResults(IEnumerable<RoslynMcpServer.Core.Models.SymbolSearchResult> results)
        {
            if (!results.Any())
        ...
        private string FormatReferences(IEnumerable<RoslynMcpServer.Core.Models.ReferenceResult> results)
        {
            if (!results.Any())
        ...
        private string FormatSymbolInfo(RoslynMcpServer.Core.Models.SymbolInfo symbolInfo)
        {
            var builder = new StringBuilder();
