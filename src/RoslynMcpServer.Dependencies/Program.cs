...
namespace RoslynMcpServer.Dependencies;
...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        Log.Logger = new LoggerConfiguration()
            ...
            .WriteTo.File(
                path: Path.Combine(logDirectory, "dependencies-startup-.log"),
        ...
        try
        {
            Log.Information("Starting RoslynMcpServer.Dependencies...");
            Log.Information("This MCP server provides 5 dependency analysis tools (~875 tokens)");
            ...
            var logFileName = environment == "Development" ? "dependencies-debug-.log" : "dependencies-.log";
            ...
            builder.Services.AddSerilog((services, loggerConfiguration) =>
            {
                loggerConfiguration
                    ...
                    .Enrich.WithProperty("McpServer", "Dependencies");
            ...
            // Register services needed for dependency tools
            ...
            logger.LogInformation("RoslynMcpServer.Dependencies started successfully");
            logger.LogInformation("Available tools: AnalyzeDependencies, GetDependencyGraph, FindUnusedDependencies, AnalyzePackages, AnalyzeDIContainer");
