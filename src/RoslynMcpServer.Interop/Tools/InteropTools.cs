...
/// <summary>
/// MCP Tools for Native AOT, interop compatibility, and unsafe code analysis.
/// This module provides 3 tools: AOT compatibility, P/Invoke analysis, and unsafe code analysis.
/// </summary>
[McpServerToolType]
public class InteropTools
{
    ...
    private static string FormatUnsafeSummary(UnsafeCodeAnalysisResults results)
    {
        ...
        // Safety score: 100 - (Critical×10 + High×5 + Medium×3 + Low×1), minimum 0
